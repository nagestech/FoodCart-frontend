  ...
  return (
    <SafeAreaView
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={{height: 80, padding: 10, justifyContent: 'center'}} >
          <View
            style={{
              height: 50,
        ...
        <TouchableOpacity style={{height: 80, padding: 10, justifyContent: 'center'}} onPress={()=>navigation.navigate("Profile")}>
          <View
            style={{
              height: 50,
              backgroundColor: theme.colors.primary,
        ...
        <TouchableOpacity style={{height: 80, padding: 10, justifyContent: 'center'}} onPress={()=>navigation.navigate("Restaurant")}>
          <View
            style={{
              height: 50,
              backgroundColor: theme.colors.primary,
