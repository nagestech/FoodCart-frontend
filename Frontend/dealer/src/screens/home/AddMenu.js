...
export function AddMenu({navigation}) {
    ...
    <SafeAreaView
      ...
      <View style={{flexDirection: 'row', padding: 10}}>
        ...
        <View style={{flex: 1, justifyContent: "center", paddingLeft: 10}}>
          <Text style={{fontFamily: "Poppins-Regular", fontSize: 20, marginTop: 5}}>Add Menu</Text>
        </View>
      </View>
      <ScrollView style={{padding: 10}} showsVerticalScrollIndicator={false}>
        ...
        <MultipleSelectList
          ...
          boxStyles={{borderRadius: 5}}
        />
        <Button mode="contained" style={{marginTop: 30, marginBottom: 50}} onPress={AddMenuSubmit}>
          <Text style={{color: 'white', fontFamily: 'Poppins-Regular'}}>
            Submit
          </Text>
        </Button>
